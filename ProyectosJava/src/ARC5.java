...
public class ARC5 extends Applet implements ActionListener, MouseListener, KeyListener, ItemListener {
    //registros
        ...
        opcondicion() {
            if (cond.getText().equals("0")){ //use next address loc=loc+1
               ...
               loc.setText(jumpaddr.getText());
                ...
                ayuda=1024 + (Integer.parseInt(irop.getText()))*256 +(Integer.parseInt(irop3.getText())) *8;
                Integer.toString(ayuda);
            }
        }
    }
}
