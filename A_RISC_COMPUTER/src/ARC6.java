...
//Version verificada para ldx, ldy, y suma
//registros + mem principal + alu + mir + memcontrol
import java.applet.Applet;
import java.awt.*;
import java.awt.event.*;

public class ARC6 extends Applet implements ActionListener, MouseListener, KeyListener, ItemListener {
    //registros
    ...
    public void init() {
        ...
        dirmca.setLocation(250 + 850, 60 + 480);
        add(dirmca);
    ...
    class operacion { //alu
        ...
        operacion() {
            if (chkdec.getState()) {  //decimal
                //alua = Integer.parseInt(busa.getText());
                //alub = Integer.parseInt(busb.getText());
                alua = Long.parseLong(busa.getText());
                alub = Long.parseLong(busb.getText());
            } else {    //hexadecimal
                alua = Integer.valueOf(busa.getText(), 16);
                alub = Integer.valueOf(busb.getText(), 16);
            }
            ...
            if (chkdec.getState()) {  //decimal
              ...
              //  busa.setText(Integer.toHexString(alua));
              //  busb.setText(Integer.toHexString(alub));
              //  busc.setText(Integer.toHexString(aluc));
            }
    ...
    class optarea {
        ...
        optarea() {
            if (wr.getText().equals("1") ) {  //escribe en memoria busa=dir, busb=dato
                memoria[Integer.parseInt(busa.getText())+0] = (Integer.parseInt(busb.getText())&0xFF000000)>>24;
                memoria[Integer.parseInt(busa.getText())+1] = (Integer.parseInt(busb.getText())&0x00FF0000)>>16;
                memoria[Integer.parseInt(busa.getText())+2] = (Integer.parseInt(busb.getText())&0x0000FF00)>>8;
                memoria[Integer.parseInt(busa.getText())+3] = (Integer.parseInt(busb.getText())&0x000000FF)>>0;
            }
        }
    }
        ...
        opcondicion() {
            if (cond.getText().equals("0")){ //use next address loc=loc+1
               ...
               loc.setText(jumpaddr.getText());
                ...
                ayuda=1024 + (Integer.parseInt(irop.getText()))*256 +(Integer.parseInt(irop3.getText())) *4;
